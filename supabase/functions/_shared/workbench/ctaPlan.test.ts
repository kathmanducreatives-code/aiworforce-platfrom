...
import { buildCtaPlan, validateCta, hasCta } from "./ctaPlan.ts";
import { buildSellerContext, buildSellerClaims, detectBrainContradictions } from "./sellerContext.ts";
import { scoreOpenerCandidate, selectBestCandidate } from "./openerCandidates.ts";
