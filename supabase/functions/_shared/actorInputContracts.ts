  ...
  Object.freeze({
    ...
    apify_yc_companies_memo23: {
      ...
      selection_notes: [
        ...
        "THIS ACTOR CANNOT ESTABLISH FUNDING STAGE. There is no funding field; `batch` is an accelerator cohort, not a round. Recent batches are a reasonable place to LOOK for seed-stage companies, but a batch never PROVES stage — the stage constraint stays hard and is judged from company evidence. The size ceiling is enforced by the engine from the mission and Company Brain bound; a wider `maxEmployeeSize` is clamped.",
