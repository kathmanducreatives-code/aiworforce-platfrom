  ...
  Object.freeze({
    ...
    apify_linkedin_job_search: {
      ...
      fields: [
        ...
        { name: "workplaceType", type: "array", enum: ["remote", "hybrid", "office"] },
        { name: "employmentType", type: "array", enum: ["full-time", "part-time", "contract", "internship", "temporary"] },
        { name: "experienceLevel", type: "array", enum: ["internship", "entry", "associate", "mid-senior", "director", "executive"] },
        { name: "salary", type: "array", enum: ["40k+", "60k+", "80k+", "100k+", "120k+", "140k+", "160k+", "180k+", "200k+"] },
