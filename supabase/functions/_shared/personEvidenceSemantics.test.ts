...
import { buildCanonicalStamp } from "./leadCanonicalStamp.ts";
import { checkEvidenceInvariants, classifyEvidence, evidenceCategory } from "./evidenceType.ts";
import { deriveCompanyIcp } from "./companyBrainIcp.ts";
