...
import { resolveProviderSource } from "./plannedToolResolver.ts";
import { buildProviderIndexFromItems, parseScoutCandidates, guardScoutToAria, type NormalizedProviderItem } from "./leadHandoffGuard.ts";
import { classifyProviderSourceOutcome, buildProviderSourceNoResults } from "./leadSourcingGate.ts";
import { filterPlanForMode, stepAllowedInMode } from "./executionMode.ts";
import { FROZEN_Q1_GENERIC_INPUT, FROZEN_MALFORMED_PAYLOAD, FROZEN_Q1_SCOUT_INSTRUCTION } from "./peopleSearchInputFixture.ts";
