...
import { compileEffectiveCompanyPolicy } from "./companyBrainEffectivePolicy.ts";
import { resolveCompanySizeBounds, SIZE_REGISTRY_VERSION } from "./companyBrainSizeRegistry.ts";
import { runCompoundSourcing, type CompoundJob, type CompoundPerson } from "./compoundSourcingPipeline.ts";
