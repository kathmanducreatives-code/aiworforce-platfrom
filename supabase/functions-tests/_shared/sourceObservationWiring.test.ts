...
} from "../../functions/_shared/sequentialSourceBridge.ts";
import {
  runCompanyFirstQuotaController,
  type RoundObservationInput,
} from "../../functions/_shared/companyFirstQuotaController.ts";
import { SOURCE_EXECUTION_KEY, stepOf } from "../../functions/_shared/sourceExecutionState.ts";
import { FUSION_STATE_KEY, newFusionState, type HiringEvidenceFusionState } from "../../functions/_shared/hiringEvidenceFusion.ts";
import {
...
import { emptyFunnelSummary, type FunnelSummary } from "../../functions/_shared/sourcingBottleneck.ts";
import { compileLeadEntityIntent } from "../../functions/_shared/leadEntityIntent.ts";
import type { LeadMissionSourceProfile } from "../../functions/_shared/hiringSourcePlan.ts";
...
import { isContinuable, projectStatus } from "../../functions/_shared/taskStatusContract.ts";
...
Deno.test("1./2. both authorities have a real non-test production caller", async () => {
  ...
  assert(bridgeSrc.includes('from "../../functions/_shared/sourceFeedbackRuntime.ts"'),
