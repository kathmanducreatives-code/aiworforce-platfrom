...
} from "../../functions/_shared/locationMatch.ts";
import { classifyResults } from "../../functions/_shared/sourceQuality.ts";
import { validateSourcingResults } from "../../functions/_shared/sourcingRetry.ts";
import { filterPeopleCandidates } from "../../functions/_shared/sourceGates.ts";
...
import { RAW_LOCATION_A, RAW_LOCATION_C, rawProfile } from "../../functions/_shared/peopleLocationFixture.ts";
