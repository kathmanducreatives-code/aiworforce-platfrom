...
} from "../../functions/_shared/hiringSourceCatalog.ts";
import {
...
import { SOURCE_TYPE_TO_ACTOR } from "../../functions/_shared/actorInputSchemas.ts";
import { readIntelligenceFlags } from "../../functions/_shared/intelligence/intelligenceFlags.ts";
...
Deno.test("S12 a 45-day Indeed window is repaired to 14 and diagnosed", () => {
  ...
  // Verified 2026-08-01 against the LIVE actor: numeric day strings only.
