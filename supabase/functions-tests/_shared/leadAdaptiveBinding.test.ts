...
import { validateRoleTaxonomy } from "../../functions/_shared/leadRoleTaxonomy.ts";
import { validateQueryPacks, type QueryPack } from "../../functions/_shared/leadQueryPacks.ts";
import { deterministicRevenueOpsTaxonomy, deterministicRevenueOpsPacks } from "../../functions/_shared/leadAdaptiveContext.ts";
import { approvedToAdaptive, bindFeedbackAskClaude, resolveAdaptiveOrderedPlan } from "../../functions/_shared/leadAdaptiveRuntime.ts";
...
import { adaptiveStrategyFromLeadStrategy } from "../../functions/_shared/leadStrategyAdapter.ts";
import { adaptiveCapabilityCards } from "../../functions/_shared/leadCapabilityCards.ts";
import type { LeadInitialStrategy } from "../../functions/_shared/leadStrategy.ts";
import type { MissionTruth } from "../../functions/_shared/leadSourceStrategy.ts";
