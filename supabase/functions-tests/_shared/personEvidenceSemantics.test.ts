...
import { buildLeadAnalystSummary } from "../../functions/_shared/leadAnalyst.ts";
import { buildCanonicalStamp } from "../../functions/_shared/leadCanonicalStamp.ts";
import { checkEvidenceInvariants, classifyEvidence, evidenceCategory } from "../../functions/_shared/evidenceType.ts";
import { deriveCompanyIcp } from "../../functions/_shared/companyBrainIcp.ts";
