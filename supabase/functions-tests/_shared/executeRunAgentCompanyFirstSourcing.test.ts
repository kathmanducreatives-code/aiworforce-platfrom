...
import { executeRunAgentCompanyFirstSourcing, type CompanyFirstRuntimeDeps } from "../../functions/_shared/executeRunAgentCompanyFirstSourcing.ts";
import { isCompanyFirstRequest } from "../../functions/_shared/runAgentCompoundBridge.ts";
import type { CompoundPersistencePlan } from "../../functions/_shared/runAgentCompoundPersistenceAdapter.ts";
