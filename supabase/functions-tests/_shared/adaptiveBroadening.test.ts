...
import { getJobFamily, validateTitleForFamily, inferFamilyKey } from "../../functions/_shared/jobFamilyRegistry.ts";
import { buildSourcingConstraints, hardConstraintsUnchanged } from "../../functions/_shared/sourcingConstraints.ts";
import { buildInitialPlan, deterministicRoundPlan, sanitizePlannerInput, type PlannerProposal, type RoundPlan } from "../../functions/_shared/broadeningPlan.ts";
import { validateRoundPlan, detectInjection, scanProposalForInjection } from "../../functions/_shared/broadeningValidator.ts";
import { classifyBottleneck, emptyFunnelSummary } from "../../functions/_shared/sourcingBottleneck.ts";
import { forecastRoundCost, roundIdempotencyKey, newIdempotencyLedger, DEFAULT_COST_POLICY } from "../../functions/_shared/sourcingCostForecast.ts";
import { runCompanyFirstQuotaController } from "../../functions/_shared/companyFirstQuotaController.ts";
import { canonicalJson, shortHash } from "../../functions/_shared/planHash.ts";
