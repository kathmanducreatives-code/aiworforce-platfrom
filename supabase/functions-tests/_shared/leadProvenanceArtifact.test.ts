...
import { buildProvenanceRecord, type ProvenanceCtx } from "../../functions/_shared/leadHandoffGuard.ts";
import { sealProvenance } from "../../functions/_shared/leadPersistenceGuard.ts";
import { ACTOR_IMPL, artifactTypeForActor } from "../../functions/_shared/leadEntityIntent.ts";
