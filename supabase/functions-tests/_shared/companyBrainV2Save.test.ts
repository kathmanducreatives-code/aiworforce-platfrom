...
import { mergeV2Patch, applyBrainSave, deriveSignalPreferences } from "../../functions/_shared/companyBrainV2Save.ts";
import { computeCompanyBrainCompleteness, canActivateBrain } from "../../functions/_shared/companyBrainCompleteness.ts";
import { normalizeCompanyBrain } from "../../functions/_shared/normalizeCompanyBrain.ts";
