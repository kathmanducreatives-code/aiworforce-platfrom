...
import { canonicalRecipient, recipientMatchesDisplayedContact } from "../../functions/_shared/outreachRecipient.ts";
import {
...
import type { ResolvedPerson } from "../../functions/_shared/decisionMakerResolver.ts";
