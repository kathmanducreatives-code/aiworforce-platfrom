...
import { compoundJobsFromRawRows, normalizedJobToCompoundJob } from "../../functions/_shared/runAgentCompoundJobAdapter.ts";
import { peopleRowToCompoundPerson, compoundPeopleFromRows, buildScopedPeopleInput } from "../../functions/_shared/runAgentCompoundPeopleAdapter.ts";
