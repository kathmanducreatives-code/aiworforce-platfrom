...
import { buildCtaPlan, validateCta, hasCta } from "../../functions/_shared/ctaPlan.ts";
import { buildSellerContext, buildSellerClaims, detectBrainContradictions } from "../../functions/_shared/sellerContext.ts";
import { scoreOpenerCandidate, selectBestCandidate } from "../../functions/_shared/openerCandidates.ts";
