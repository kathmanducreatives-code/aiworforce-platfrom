...
import { runCompoundSourcing, type CompoundDeps } from "../../functions/_shared/compoundSourcingPipeline.ts";
...
import { buildCompanyRowPersistencePlan, companyRowKey, companyRowStage } from "../../functions/_shared/companyRowProjection.ts";
import {
  ALL_PROVIDER_ROWS, LINKEDIN_ROWS, INDEED_ROWS, PEOPLE_BY_KEY, PEOPLE_BY_KEY_PARTIAL, E2E_NOW,
} from "../../functions/_shared/qualifiedLeadE2E.fixture.ts";
