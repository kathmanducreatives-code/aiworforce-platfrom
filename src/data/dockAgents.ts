...
export const deptColor: Record<DockDept, { ring: string; dot: string; text: string; bg: string }> = {
  talent: { ring: 'ring-emerald-500/70', dot: 'bg-emerald-500', text: 'text-emerald-400', bg: 'from-emerald-500/30 to-emerald-700/30' },
  growth: { ring: 'ring-blue-500/70', dot: 'bg-blue-500', text: 'text-blue-400', bg: 'from-blue-500/30 to-blue-700/30' },
  content: { ring: 'ring-violet-500/70', dot: 'bg-violet-500', text: 'text-violet-400', bg: 'from-violet-500/30 to-violet-700/30' },
  intelligence: { ring: 'ring-amber-500/70', dot: 'bg-amber-500', text: 'text-amber-400', bg: 'from-amber-500/30 to-amber-700/30' },
};
