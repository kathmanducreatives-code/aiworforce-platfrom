        ...
        <div className="space-y-2">
          {SOURCES.map(({ key, icon: Icon, label, brief }) => (
            <button
              ...
              className="w-full flex items-center gap-3 px-4 py-3 rounded-xl border border-border/70 bg-background/40 hover:border-primary/40 hover:bg-background/70 text-left transition"
            >
