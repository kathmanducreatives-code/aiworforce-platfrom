...
const Header = ({ className }: { className?: string }) => {
  ...
  return <header className={`fixed top-0 left-0 right-0 z-50 backdrop-blur-xl border-b border-primary/20 shadow-primary ${className || 'bg-background/90'}`}>
      <div className="container mx-auto px-6">
        <div className="flex items-center justify-between h-16">
          ...
          {/* Mobile Menu Button */}
          <button className="lg:hidden p-2 text-muted-foreground hover:text-foreground hover:bg-accent/50 rounded-lg transition-all duration-200" onClick={() => setIsMenuOpen(!isMenuOpen)}>
        ...
        {/* Mobile Menu */}
        {isMenuOpen && <div className="lg:hidden py-4 border-t border-border/50 animate-slide-down">
