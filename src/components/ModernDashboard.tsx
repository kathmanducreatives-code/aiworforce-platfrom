                            ...
                            >
                              ...
                              <TableCell className="py-6 px-6 text-center">
                                <div className="flex flex-col items-center gap-2">
                                  <Badge className={`text-xs px-3 py-1.5 font-semibold rounded-full border-0 flex items-center justify-center gap-2 min-w-[9rem] transition-all duration-300 hover:scale-110 hover:-translate-y-0.5 cursor-default animate-pulse ${riskBadge.color}`}>
                                    <riskBadge.icon className="h-3.5 w-3.5" />
                                    Risk: {resume.riskScore || 'Unknown'}
                                  </Badge>
                                  <Badge className={`text-xs px-3 py-1.5 font-semibold rounded-full border-0 flex items-center justify-center gap-2 min-w-[9rem] transition-all duration-300 hover:scale-110 hover:-translate-y-0.5 cursor-default animate-pulse ${rewardBadge.color}`}>
