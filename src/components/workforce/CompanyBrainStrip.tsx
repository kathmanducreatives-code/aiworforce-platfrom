  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-1.5 flex-wrap">
        {MODULES.map((m) => (
          <span key={m} className="ag-badge-outline inline-flex items-center h-6 px-2 rounded-md text-[11px]">
            {m}
          </span>
        ))}
      </div>
      <button
        ...
        className="ag-btn ag-btn-primary inline-flex items-center gap-1.5 h-8 px-3 rounded-lg text-[12.5px] font-medium shrink-0"
      >
        Continue setup
