  ...
  return (
    <div className="rounded-xl border border-emerald-500/20 bg-gradient-to-b from-emerald-500/[0.05] to-transparent p-4 w-full min-w-0">
      ...
      <div className="flex items-center gap-2 mt-4 flex-wrap">
        <Button size="sm" disabled={missing} onClick={() => { send(buildInstruction(option.source_type, v, option.available), conversationId, { lead_request: v, source_type: option.source_type }); setSent(true); }}>
          Find leads
        </Button>
