const row1 = 'STOP PAYING 20% AGENCY FEES ◆ SCREEN 500+ CANDIDATES IN SECONDS ◆ AUTO-REJECT 95% OF BAD FITS ◆ ';
const row2 = 'REPLACE YOUR AGENCY FOR €149/MONTH ◆ NO PER-HIRE FEES EVER ◆ YOUR AGENCY IS OBSOLETE ◆ ';
