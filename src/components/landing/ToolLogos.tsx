...
export const TOOL_BRANDS: Record<string, { bg: string; color: string; label: string; sublabel: string; logo: string; agents: string[] }> = {
  ...
  perplexity:  { bg: "#20808D", color: "#fff", label: "Perplexity",  sublabel: "Real-time Research",    logo: "/tool-logos/perplexity.svg", agents: ["Radar", "Codex"] },
  ...
  hunter:      { bg: "#F5A623", color: "#fff", label: "Hunter.io",   sublabel: "Email Discovery",       logo: "/tool-logos/hunter.svg", agents: ["Codex"] },
  ...
  replicate:   { bg: "#393939", color: "#fff", label: "Replicate",   sublabel: "Image Generation",      logo: "/tool-logos/replicate.svg", agents: ["Aria"] },
  ...
  cal:         { bg: "#111827", color: "#fff", label: "Cal.com",      sublabel: "Scheduling",           logo: "/tool-logos/cal.svg", agents: ["Scout"] },
  canva:       { bg: "#00C4CC", color: "#fff", label: "Canva",       sublabel: "Design Handoff",        logo: "/tool-logos/canva.svg", agents: ["Aria"] },
  gamma:       { bg: "#6C47FF", color: "#fff", label: "Gamma",       sublabel: "Presentations",         logo: "/tool-logos/gamma.svg", agents: ["Aria"] },
