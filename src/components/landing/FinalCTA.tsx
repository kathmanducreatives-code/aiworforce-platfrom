        ...
        <section className="relative px-4 py-28 md:py-36 overflow-hidden">
            ...
            <div className="relative z-10 text-center max-w-3xl mx-auto">
                ...
                <h2 className="font-display font-black text-[clamp(2rem,4.5vw,3.8rem)] leading-[1.05] tracking-[-0.04em] text-white mb-8">
                    Your AI workforce is ready.<br />They just need to know<br />your company.
                </h2>
                <p className="text-lg text-white/40 mb-10 max-w-xl mx-auto leading-relaxed">
                    Ten minutes. Twelve questions. From that moment your agents are briefed, your departments are active, and your workforce is running. You focus on building. They handle everything else.
                </p>
                ...
                <p className="text-xs text-white/20 mt-6">14-day free trial · No credit card · Join 50+ countries · Cancel anytime</p>
                <p className="text-xs text-white/15 mt-2 italic">Early access pricing locks in for life.</p>
            </div>
        </section>
    );
};
