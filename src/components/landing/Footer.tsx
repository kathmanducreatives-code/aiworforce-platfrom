  ...
  <footer className="relative border-t border-white/5 bg-black px-6 py-24">
    <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-16 mb-24">
      ...
      <div className="md:col-span-4">
        ...
        <div className="flex gap-4">
           {[Twitter, Linkedin, Mail].map((Icon, i) => (
             <a key={i} href="#" className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-white/30 hover:text-accent-mint hover:border-accent-mint/30 transition-all">
      ...
      <div className="md:col-span-8 grid grid-cols-2 sm:grid-cols-3 gap-12">
        <div>
          <h4 className="text-[10px] font-black uppercase tracking-[0.2em] text-white/20 mb-8">Product</h4>
          <div className="space-y-4">
            {['Workforce', 'Talent', 'Growth', 'Intelligence'].map((l) => (
              <a key={l} href="#" className="block text-sm text-white/40 hover:text-accent-mint transition-colors font-medium">{l}</a>
            ))}
          </div>
        </div>
        <div>
          <h4 className="text-[10px] font-black uppercase tracking-[0.2em] text-white/20 mb-8">Legal</h4>
          <div className="space-y-4">
        ...
        <div>
          <h4 className="text-[10px] font-black uppercase tracking-[0.2em] text-white/20 mb-8">Support</h4>
          <div className="space-y-4">
    ...
    <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8 pt-12 border-t border-white/5">
       <div className="flex items-center gap-2">
          ...
          <span className="text-[10px] font-black text-white/20 uppercase tracking-widest">System Status: All Systems Operational</span>
       </div>
       <div className="text-[10px] font-black text-white/20 uppercase tracking-widest">
          © 2026 SCREENINGPILOT AGENTS. ALL RIGHTS RESERVED.
       </div>
    </div>
  </footer>
);
