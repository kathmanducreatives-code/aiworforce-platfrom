...
const rows = [
    { task: 'Finding candidates', manual: '3–4 weeks, 45 hours', sp: '12–15 minutes' },
    { task: 'Screening 100 resumes', manual: '8–10 hours', sp: 'Instant (AI scores all)' },
    { task: 'Finding emails', manual: '2–3 hours', sp: 'One click' },
    { task: 'Personalized outreach', manual: '30 min per candidate', sp: 'Automated for all' },
    { task: 'Full cycle', manual: '50–60 hours', sp: 'Under 1 hour', highlight: true },
];
        ...
        <section ref={sectionRef} className="relative px-4 py-28 md:py-36">
            <div className="max-w-4xl mx-auto">
                <div className="text-center mb-14">
                    <p className="font-mono text-xs uppercase tracking-[0.15em] mb-4 text-emerald-400 font-semibold">◆ The Time Math</p>
                ...
                <div ref={tableRef} className="glass-strong rounded-2xl overflow-hidden">
                    <div className="grid grid-cols-3 gap-0 text-xs font-semibold text-white/30 uppercase tracking-wider px-6 py-4 border-b border-white/[0.06]">
                        <span>Task</span><span>Manual / Agency</span><span className="text-emerald-400">ScreeningPilot</span>
                    </div>
                    {rows.map((row, i) => (
