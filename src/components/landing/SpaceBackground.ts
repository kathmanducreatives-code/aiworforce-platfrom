...
class SpaceBackground {
  ...
  private drawStaticParticles(ctx: CanvasRenderingContext2D) {
    this.staticParticles.forEach((particle) => {
      ...
      const color =
        particle.tint === "teal"
          ? `rgba(200, 255, 240, ${particle.alpha.toFixed(3)})`
  ...
  private drawNebula(ctx: CanvasRenderingContext2D) {
    ...
    gradient.addColorStop(0, "rgba(0, 200, 180, 0.12)");
  ...
  private drawPulsingParticles(time: number) {
    ...
    this.pulsingParticles.forEach((particle) => {
      ...
      const color =
        particle.tint === "teal"
          ? `rgba(200, 255, 240, ${alpha.toFixed(3)})`
  ...
  private drawArc(time: number) {
    ...
    outerGradient.addColorStop(0, "rgba(0, 200, 180, 0.15)");
    outerGradient.addColorStop(0.4, "rgba(0, 200, 180, 0.08)");
    outerGradient.addColorStop(1, "rgba(0, 200, 180, 0)");
    ...
    innerGradient.addColorStop(0, "rgba(0, 255, 200, 0.4)");
    innerGradient.addColorStop(0.35, "rgba(0, 255, 200, 0.16)");
    innerGradient.addColorStop(1, "rgba(0, 255, 200, 0)");
    ...
    coreGradient.addColorStop(0, "rgba(0, 255, 220, 0.9)");
    coreGradient.addColorStop(0.18, "rgba(0, 255, 220, 0.58)");
    coreGradient.addColorStop(0.6, "rgba(0, 255, 220, 0.08)");
    coreGradient.addColorStop(1, "rgba(0, 255, 220, 0)");
  ...
  private drawArcSparks(points: ReturnType<SpaceBackground["getArcPoints"]>) {
    this.arcSparks.forEach((spark) => {
      ...
      this.ctx.save();
      this.ctx.beginPath();
      this.ctx.fillStyle = `rgba(220, 255, 248, ${alpha.toFixed(3)})`;
      this.ctx.shadowBlur = 10;
      this.ctx.shadowColor = "rgba(0, 255, 220, 0.18)";
