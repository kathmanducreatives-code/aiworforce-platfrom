...
const DEPARTMENTS: DeptCard[] = [
  ...
  },
  {
    ...
    activities: [
      { done: true, text: "Lisa flagged Acme Corp — funding signal" },
      { done: true, text: "Lyra drafted outreach referencing that signal" },
      { done: false, text: "Lyra drafting follow-ups for 12 leads in queue" },
  ...
  },
  {
    ...
    activities: [
      { done: true, text: "Lyra wrote a LinkedIn post in your brand voice" },
      { done: false, text: "Lyra drafting a newsletter for tomorrow" },
      { done: true, text: "Lyra queued 3 pieces of content this week" },
  ...
  },
  {
    ...
    activities: [
      { done: true, text: "Lisa detected a competitor pricing change" },
      { done: true, text: "Lisa refreshed hiring and market data" },
      { done: true, text: "Lisa delivered the morning brief — 3 signals found" },
      { done: false, text: "Lisa scanning 23 competitor job postings" },
