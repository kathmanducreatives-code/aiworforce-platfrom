        ...
        <div className="flex flex-col h-full relative space-y-3">
            ...
            {profile && (
                <div className="animate-in slide-in-from-top-4 fade-in duration-700">
                    <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-[#0d1117] to-[#161b22] border border-white/[0.06] p-5">
                        {/* Subtle glow accent */}
                        <div className="absolute -top-8 -right-8 w-32 h-32 bg-[#00FF85]/[0.06] blur-3xl rounded-full pointer-events-none" />
                        ...
                        <div className="relative flex flex-col sm:flex-row gap-4 items-start sm:items-center">
                            ...
                            <div className="relative flex-shrink-0">
                                <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#00FF85]/20 to-[#00FF85]/5 flex items-center justify-center border border-[#00FF85]/15 shadow-[0_0_20px_rgba(0,255,133,0.08)]">
                                    {profile.photo_url ? (
                                        <img src={profile.photo_url} alt={profile.name} className="w-full h-full rounded-2xl object-cover" />
                                    ) : (
                                        <User className="w-6 h-6 text-[#00FF85]/70" />
                                    )}
                                </div>
                                <div className="absolute -bottom-1 -right-1 w-5 h-5 rounded-full bg-[#00FF85] flex items-center justify-center shadow-[0_0_8px_rgba(0,255,133,0.5)]">
                            ...
                            <div className="flex-1 min-w-0 space-y-1.5">
                                <div className="flex items-center gap-2.5 flex-wrap">
                                    <h4 className="text-white font-semibold text-base tracking-tight">{profile.name}</h4>
                                    <Badge className="bg-[#00FF85]/10 text-[#00FF85] border border-[#00FF85]/20 text-[10px] font-semibold tracking-wide uppercase px-2 py-0.5 shadow-[0_0_6px_rgba(0,255,133,0.15)]">
                                        Analyzed Reference
                                    </Badge>
                                </div>
            ...
            <div className="animate-in fade-in slide-in-from-bottom-3 duration-700 delay-500 fill-mode-forwards opacity-0" style={{ animationDelay: '500ms' }}>
                <div className="relative overflow-hidden rounded-2xl border border-[#00FF85]/15 bg-gradient-to-b from-[#0A0F0D] via-[#0A0A0A] to-[#0d0d0d] shadow-[0_4px_32px_rgba(0,255,133,0.06)]">
                    {/* Top accent bar */}
                    <div className="h-[2px] bg-gradient-to-r from-transparent via-[#00FF85]/50 to-transparent" />

                    {/* Decorative glow */}
                    <div className="absolute top-0 right-0 -mt-6 -mr-6 w-28 h-28 bg-[#00FF85]/[0.07] blur-3xl rounded-full pointer-events-none animate-pulse" />

                    <div className="relative z-10 p-6">
                        <div className="flex items-center gap-2.5 mb-4">
                            <div className="p-1.5 rounded-lg bg-[#00FF85]/10 border border-[#00FF85]/15">
                                <Brain className="w-4 h-4 text-[#00FF85]" />
                            </div>
                            <span className="text-xs font-bold tracking-[0.15em] uppercase text-[#00FF85]/80">Generated Strategy</span>
                        </div>

                        {isRefining ? (
                            <div className="flex items-center gap-3 py-10">
                                <Loader2 className="w-5 h-5 animate-spin text-[#00FF85]" />
                                <span className="text-lg font-medium text-white/60 animate-pulse">Refining Strategy...</span>
                            </div>
                        ) : (
                            <div className="min-h-[80px]">
                                <Textarea
                                    ...
                                    className={cn(
                                        "text-base md:text-lg font-medium leading-[1.7] text-white/90 bg-transparent border-none focus-visible:ring-0 focus-visible:ring-offset-0 resize-none p-0 h-auto w-full placeholder:text-white/20",
            ...
            <div className={cn(
                ...
                <Accordion type="single" collapsible defaultValue="item-1" className="space-y-3">
                    ...
                    {/* Search Logic DNA */}
                    <AccordionItem value="item-1" className="border border-white/[0.06] rounded-2xl bg-gradient-to-b from-[#111] to-[#0d0d0d] overflow-hidden data-[state=open]:border-[#00FF85]/20 data-[state=open]:shadow-[0_0_20px_rgba(0,255,133,0.04)] transition-all duration-300">
                        <AccordionTrigger className="px-5 py-4 hover:bg-white/[0.02] hover:no-underline [&[data-state=open]]:bg-[#00FF85]/[0.03]">
                            <div className="flex items-center gap-3">
                                <div className="p-2 rounded-xl bg-blue-500/10 text-blue-400 border border-blue-500/10">
                                    <Search className="w-4 h-4" />
                                </div>
                                <div className="text-left">
                                    <h4 className="font-semibold text-sm text-white/90">Search Logic DNA</h4>
                            ...
                            <div className="space-y-3">
                                <div className="relative">
                                    <Textarea
                                        ...
                                        className="bg-black/60 border-white/[0.06] ring-1 ring-white/[0.04] focus-visible:ring-[#00FF9D]/40 min-h-[120px] resize-y font-mono text-xs leading-relaxed tracking-wide text-[#00FF9D] drop-shadow-[0_0_2px_rgba(0,255,157,0.3)] selection:bg-[#00FF9D]/30 rounded-xl"
                                        spellCheck={false}
                                        placeholder="// Search Logic DNA will be generated here..."
                                    />
                                    <div className="absolute bottom-3 right-3">
                                        <Button size="sm" variant="secondary" className="h-7 text-xs gap-1.5 bg-[#00FF9D]/10 hover:bg-[#00FF9D]/20 text-[#00FF9D] border border-[#00FF9D]/15 rounded-lg shadow-[0_0_10px_rgba(0,255,133,0.08)]">
                    ...
                    <AccordionItem value="item-2" className="border border-white/[0.06] rounded-2xl bg-gradient-to-b from-[#111] to-[#0d0d0d] overflow-hidden data-[state=open]:border-purple-500/20 data-[state=open]:shadow-[0_0_20px_rgba(168,85,247,0.04)] transition-all duration-300">
                        <AccordionTrigger className="px-5 py-4 hover:bg-white/[0.02] hover:no-underline [&[data-state=open]]:bg-purple-500/[0.03]">
                            <div className="flex items-center gap-3">
                                <div className="p-2 rounded-xl bg-purple-500/10 text-purple-400 border border-purple-500/10">
                                    <Globe className="w-4 h-4" />
                                </div>
                                <div className="text-left">
                                    <h4 className="font-semibold text-sm text-white/90">Firmographic Constraints</h4>
                            ...
                            <div className="flex flex-wrap gap-2">
                                {value.strategyData?.firmographic_constraints && Object.keys(value.strategyData.firmographic_constraints).length > 0 ? (
                                    Object.entries(value.strategyData.firmographic_constraints).map(([key, val]) => (
                                        <Badge key={key} variant="outline" className="h-8 pl-2.5 pr-3 gap-1.5 bg-white/[0.03] hover:bg-white/[0.06] border-white/[0.08] transition-colors cursor-default rounded-lg">
                                    ...
                                    <>
                                        {value.company_location && value.company_location.length > 0 && (
                                            <Badge variant="outline" className="h-8 pl-2.5 pr-3 gap-1.5 bg-white/[0.03] border-white/[0.08] rounded-lg">
                                        ...
                                        {value.industries.map(id => (
                                            <Badge key={id} variant="outline" className="h-8 pl-2.5 pr-3 gap-1.5 bg-white/[0.03] border-white/[0.08] rounded-lg">
                    ...
                    {/* Technical Execution */}
                    <AccordionItem value="item-3" className="border border-white/[0.06] rounded-2xl bg-gradient-to-b from-[#111] to-[#0d0d0d] overflow-hidden data-[state=open]:border-orange-500/20 data-[state=open]:shadow-[0_0_20px_rgba(249,115,22,0.04)] transition-all duration-300">
                        <AccordionTrigger className="px-5 py-4 hover:bg-white/[0.02] hover:no-underline [&[data-state=open]]:bg-orange-500/[0.03]">
                            <div className="flex items-center gap-3">
                                <div className="p-2 rounded-xl bg-orange-500/10 text-orange-400 border border-orange-500/10">
                                    <Cpu className="w-4 h-4" />
                                </div>
                                <div className="text-left">
                                    <h4 className="font-semibold text-sm text-white/90">Technical Execution</h4>
                                    <p className="text-xs text-muted-foreground/70">JSON payload logic</p>
                                </div>
                            </div>
                        </AccordionTrigger>
                        <AccordionContent className="px-5 pb-5 pt-2">
                            <div className="relative rounded-xl bg-black/60 border border-white/[0.06] overflow-hidden">
                                ...
                                <div className="p-4 font-mono text-xs text-green-400/80 overflow-x-auto leading-relaxed max-h-[300px] overflow-y-auto scrollbar-thin scrollbar-thumb-white/10 scrollbar-track-transparent">
