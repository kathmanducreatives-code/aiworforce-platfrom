...
export const WORKFLOWS: WorkflowDefinition[] = [
  // ─────────── Growth ───────────
  {
    ...
    category: 'growth',
    description: 'Nova finds companies hiring roles that signal growth or pain. Atlas ranks accepted accounts.',
    primaryAgent: 'scout',
    agents: ['scout', 'aria'],
  ...
  },
  {
    ...
    category: 'growth',
    description: 'Nova finds the right people at selected account opportunities.',
    primaryAgent: 'scout',
    agents: ['scout'],
