...
export const WORKFLOWS: WorkflowDefinition[] = [
  // ─────────── Growth ───────────
  {
    ...
    category: 'growth',
    description: 'Scout finds companies hiring roles that signal growth or pain. Aria ranks accepted accounts.',
    primaryAgent: 'scout',
    agents: ['scout', 'aria'],
  ...
  },
  {
    ...
    category: 'growth',
    description: 'Scout finds the right people at selected account opportunities.',
    primaryAgent: 'scout',
    agents: ['scout'],
  ...
  },
  {
    ...
    category: 'growth',
    description: 'Aria scores the current account list against your ICP and prioritizes them.',
    primaryAgent: 'aria',
    agents: ['aria'],
    outputType: 'lead_table',
  ...
  // ─────────── Research ───────────
  {
    ...
    category: 'research',
    description: 'Hawk researches company websites and extracts useful personalization context.',
    primaryAgent: 'hawk',
    agents: ['hawk'],
  ...
  },
  {
    ...
    category: 'research',
    description: 'Hawk researches, Aria scores issues, Scribe summarizes recommendations.',
    primaryAgent: 'hawk',
  ...
  // ─────────── Outreach (draft-only) ───────────
  {
    ...
    category: 'outreach',
    description: 'Penn writes approval-ready personalized drafts. Nothing is sent automatically.',
    primaryAgent: 'penn',
    agents: ['penn'],
  ...
  },
  {
    ...
    category: 'outreach',
    description: 'Penn writes 3 cold-call openers per contact, ready for review.',
    primaryAgent: 'penn',
    agents: ['penn'],
    outputType: 'draft_list',
    estimatedCredits: '~2 credits',
  ...
  },
  {
    ...
    category: 'outreach',
    description: 'Penn writes step-2 / step-3 follow-ups based on the original draft.',
    primaryAgent: 'penn',
    agents: ['penn'],
    outputType: 'draft_list',
    estimatedCredits: '~2 credits',
  ...
  },
  {
    ...
    category: 'outreach',
    description: 'Penn writes short objection-handling notes for the rep to use live.',
    primaryAgent: 'penn',
    agents: ['penn'],
    outputType: 'draft_list',
    estimatedCredits: '~2 credits',
  ...
  // ─────────── Content ───────────
  {
    ...
    category: 'content',
    description: 'Scribe turns market or lead signals into a founder-style LinkedIn post.',
    primaryAgent: 'scribe',
    agents: ['scribe'],
  ...
  },
  {
    ...
    category: 'content',
    description: 'Scribe brainstorms 10 content angles aligned to your positioning.',
    primaryAgent: 'scribe',
    agents: ['scribe'],
    outputType: 'content_doc',
    estimatedCredits: '~1 credit',
  ...
  },
  {
    ...
    category: 'content',
    description: 'Scribe drafts a founder-style weekly update from workforce activity.',
    primaryAgent: 'scribe',
    agents: ['scribe'],
    outputType: 'content_doc',
    estimatedCredits: '~2 credits',
  ...
  },
  {
    ...
    category: 'content',
    description: 'Scribe converts competitor moves into a sharp positioning post.',
    primaryAgent: 'scribe',
    agents: ['hawk', 'scribe'],
    outputType: 'content_doc',
    estimatedCredits: '~2 credits',
  ...
  },
  {
    ...
    category: 'competitor',
    description: 'Hawk audits a competitor site for positioning and ICP cues.',
    primaryAgent: 'hawk',
    agents: ['hawk', 'aria'],
    outputType: 'audit_report',
    estimatedCredits: '~4 credits',
  ...
  },
  {
    ...
    category: 'competitor',
    description: 'Scribe builds a "vs. competitor" angle from research.',
    primaryAgent: 'scribe',
    agents: ['hawk', 'scribe'],
    outputType: 'content_doc',
    estimatedCredits: '~2 credits',
  ...
  },
  {
    ...
    category: 'operations',
    description: 'Scribe writes the weekly performance report from workforce activity.',
    primaryAgent: 'scribe',
    agents: ['pilot', 'scribe'],
    outputType: 'content_doc',
    estimatedCredits: '~2 credits',
